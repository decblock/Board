            ...
            <div className="renewableMain">
                ...
                <FormControl component="fieldset">
                    ...
                    <RadioGroup row={true} aria-label="type" name="renewabletype" value={this.state.type} onChange={this.handleTypeChange}>
                        <FormControlLabel value="solar" control={<Radio style={{ 'color': 'white', '&$checked': { 'color': 'white' } }} />} label="태양광" />
                        <FormControlLabel value="wind" control={<Radio style={{ 'color': 'white', '&$checked': { 'color': 'white' } }} />} label="풍력" />
                    </RadioGroup>
                </FormControl>
